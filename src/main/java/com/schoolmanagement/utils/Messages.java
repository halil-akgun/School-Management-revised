...
public class Messages {
    ...
    public static final String ALREADY_SENT_A_MESSAGE_TODAY =
            "Error : You already sent a message with this e-mail address today";
    public static final String ALREADY_REGISTER_MESSAGE_USERNAME =
            "Error : User with username %s already register";
    public static final String ALREADY_REGISTER_MESSAGE_SSN =
            "Error : User with ssn %s already register";
    public static final String ALREADY_REGISTER_MESSAGE_PHONE_NUMBER =
            "Error : User with phone number %s already register";
    ...
    public static final String EDUCATION_START_DATE_IS_EARLIER_THAN_LAST_REGISTRATION_DATE =
            "Error: The start date cannot be earlier than the last registration date.";
    public static final String EDUCATION_END_DATE_IS_EARLIER_THAN_LAST_START_DATE =
            "Error: The end date cannot be earlier than the last start date.";
