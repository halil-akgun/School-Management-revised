...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if (student != null) return new UserDetailsImpl(
                student.getId(),
                student.getUsername(),
                student.getName(),
                false,
        ...
        else if (teacher != null) return new UserDetailsImpl(
                teacher.getId(),
                teacher.getUsername(),
                teacher.getName(),
                teacher.isAdvisor(),
        ...
        else if (dean != null) return new UserDetailsImpl(
                dean.getId(),
                dean.getUsername(),
                dean.getName(),
                false,
        ...
        else if (viceDean != null) return new UserDetailsImpl(
                viceDean.getId(),
        ...
        else if (admin != null) return new UserDetailsImpl(
                admin.getId(),
                admin.getUsername(),
                admin.getName(),
                false,
